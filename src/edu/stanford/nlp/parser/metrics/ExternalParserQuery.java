...
public class ExternalParserQuery implements ParserQuery  {
  ...
  List<ScoredObject<Tree>> results;
  boolean success;

  public ExternalParserQuery(ExternalParser parser) {
    this.parser = parser;
  }
  ...
  public boolean parse(List<? extends HasWord> sentence) {
    ...
    List<String> transformed = sentence.stream().map((x) -> x.word()).collect(Collectors.toList());
    results = parser.results.get(transformed);
